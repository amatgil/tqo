...
Table:
| Left\Right | A        | αV       | ⍵V       | DV       | N        | αA       | ⍵A       | DA       | JOT      | ARR       |
| /          | <        | <        | <        | <        | <        | <        | <        | <        | <        | <         |
|------------+----------+----------+----------+----------+----------+----------+----------+----------+----------+-----------|
| A          | _        | (x, A)   | _        | (x,⍵V)   | _        | (x, A)   | _        | (x, ⍵A)  | (x, A)   | (x, err)  |
|------------+----------+----------+----------+----------+----------+----------+----------+----------+----------+-----------|
| αV         | _        | (x, αV)  | _        | (x, DF)  | _        | (x, αV)  | _        | (x, ⍵A)  | err?     | (x, err)  |
|------------+----------+----------+----------+----------+----------+----------+----------+----------+----------+-----------|
| ⍵V         | (x, A)   | _        | (x,⍵V)   | (x, αV)  | (x, A)   | (x, αV)  | (x, err) | (x, err) | (x, ⍵V)  | (x, err)  |
|------------+----------+----------+----------+----------+----------+----------+----------+----------+----------+-----------|
| DV         | (x,Vα)   | _        | (x, DF)  | _        | (x, αV)  | (x, αV)  | (x, err) | (x, ⍵A)  |          | (x, err)  |
|------------+----------+----------+----------+----------+----------+----------+----------+----------+----------+-----------|
| N          | _        | (x, A)   | _        | (x, ⍵V)  | _        | (x, αV)  |          | (??)     |          | (x, bind) |
|------------+----------+----------+----------+----------+----------+----------+----------+----------+----------+-----------|
| αA         | _        |          |          |          |          | (x, αA)  | _        |          | err?     | (x, err)  |
|------------+----------+----------+----------+----------+----------+----------+----------+----------+----------+-----------|
| ⍵A         | ????     |          |          |          |          |          |          |          |          | (x, err)  |
|------------+----------+----------+----------+----------+----------+----------+----------+----------+----------+-----------|
| DA         | (x, A)   |          |          |          |          |          |          |          |          | (x, err)  |
