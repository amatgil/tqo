...
*** Extra
Chord to open emacs buffer with list of greek letters (like =unicode-chars-list-chars=), as well as all primitives with their unicode name and their tqo name.
